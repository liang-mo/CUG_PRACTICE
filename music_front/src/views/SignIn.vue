...
import YinLoginIcon from "@/components/layouts/YinLoginIcon.vue";
import { HttpManager } from "@/api";
import { NavName, RouterName, SignInRules } from "@/enums";

export default defineComponent({
  components: {
    YinLoginIcon: YinLoginIcon,
  },
  setup() {
    const { proxy } = getCurrentInstance();
    const { routerManager, changeIndex } = action();
