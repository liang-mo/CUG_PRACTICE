<template>
  ...
  <!--热门歌单-->
  <show-list class="play-list-container" title="歌单" path="song-sheet-detail" :playList="songList"></show-list>
  <!--热门歌手-->
  <show-list class="play-list-container" title="歌手" path="singer-detail" :playList="singerList"></show-list>
</template>
